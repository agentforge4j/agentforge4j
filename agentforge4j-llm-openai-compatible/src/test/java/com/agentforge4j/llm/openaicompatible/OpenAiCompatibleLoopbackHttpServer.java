 ...
 */
final class OpenAiCompatibleLoopbackHttpServer implements AutoCloseable {
  ...
  OpenAiCompatibleLoopbackHttpServer(int statusCode, String responseBody) {
  ...
  OpenAiCompatibleLoopbackHttpServer(int statusCode, String responseBody,
    ...
    this.thread = new Thread(this::serveOnce, "openai-compatible-loopback-http");
