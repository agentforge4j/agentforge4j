...
public final class ShippedModelTierDefaults {
  ...
  public static Map<String, Map<ModelTier, String>> asMap() {
    ...
    map.put("openai", tiers("gpt-5.4-nano", "gpt-5.4-mini", "gpt-5.5", "gpt-5.5"));
    map.put("claude",
        tiers("claude-haiku-4-5-20251001", "claude-sonnet-4-6", "claude-opus-4-8",
            "claude-opus-4-8"));
    map.put("gemini",
        tiers("gemini-3.1-flash-lite", "gemini-3.5-flash", "gemini-3.1-pro", "gemini-3.1-pro"));
    map.put("mistral",
        tiers("mistral-small-2603", "mistral-medium-3-5", "mistral-large-2512",
            "mistral-large-2512"));
    map.put("bedrock", tiers(
        ...
        "anthropic.claude-opus-4-8"));
    map.put("azure-openai", tiers("gpt-5.4-nano", "gpt-5.4-mini", "gpt-5.5", "gpt-5.5"));
    map.put("ollama", tiers("qwen3:4b", "qwen3:14b", "qwen3:32b", "qwen3:32b"));
    map.put("vllm",
        tiers("Qwen/Qwen3-4B", "Qwen/Qwen3-14B", "Qwen/Qwen3-32B", "Qwen/Qwen3-32B"));
    map.put("openai-compatible", tiers("gpt-5.4-nano", "gpt-5.4-mini", "gpt-5.5", "gpt-5.5"));
    return map;
  }
  ...
  private static Map<ModelTier, String> tiers(String lite, String standard, String powerful,
    ...
    byTier.put(ModelTier.PREMIUM, premium);
    return byTier;
  }
}
