...
/**
 * Small builder for the canonical dotted provider-option map emitted by {@link LlmClientConfigurationAdapter}
 * implementations. Null values are skipped (so optional/unset properties become absent options that the provider factory
 * defaults or rejects), keeping the backing map free of the nulls that {@link LlmProviderOptions#of(String, Map)} would
 * reject.
 */
