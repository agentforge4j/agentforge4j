 ...
 * {@link IntegrationToolProviderFactory#create} call by the aggregating
 * {@link ToolProviderFactory}. Carrying them here — rather than on each contributor's constructor —
