 ...
 * tenant/user/role concept (identity lives only in downstream implementations). Implementations live
 * downstream — the runtime owns {@code DefaultToolExecutionService}, the {@code agentforge4j-mcp}
 * module owns {@code McpToolProvider}, and an embedding application owns persistence-backed resolvers
 * and policies.
 */
