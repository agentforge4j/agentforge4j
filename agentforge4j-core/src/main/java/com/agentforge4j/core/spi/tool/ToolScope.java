 ...
 *
 * <p>Carries no tenant, user, or role: OSS core and runtime never hold such identity. The platform
 * resolves tenant/user identity inside its own {@link ToolPolicy} and {@link ToolProviderResolver}
 * implementations, never via this type. Either field may be {@code null} when not yet known.
 *
