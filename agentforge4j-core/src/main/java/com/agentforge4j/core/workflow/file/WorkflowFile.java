 ...
 * @param filePath non-blank storage path or URI understood by {@link com.agentforge4j.core.workflow.repository.WorkflowFileRepository}
...
public record WorkflowFile(
  ...
  public WorkflowFile {
    ...
    Validate.notBlank(filePath, "filePath must not be blank");
    Validate.notNull(createdAt, "createdAt must not be null");
    Validate.isTrue(sizeBytes >= 0, "sizeBytes must not be negative");
  }
}
