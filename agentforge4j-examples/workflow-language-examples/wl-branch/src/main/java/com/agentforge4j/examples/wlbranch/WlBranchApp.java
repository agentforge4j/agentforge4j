 ...
 * module's POM to run the same workflow against a real model — no code change. The fake/real choice is
 * resolved by {@link ExampleLlmConfig}; the workflow and agent definitions are identical on both paths.
 */
