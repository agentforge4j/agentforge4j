...
/**
 * Black-box coverage of the step behaviours (FAIL, BRANCH, RESOURCE, WORKFLOW nesting, INPUT, SPAR, COMPACT,
 * ASSIGN_CONTEXT). AGENT is exercised throughout the command/loop tiers. Each behaviour drives a focused fixture and
 * asserts its observable effect.
 */
