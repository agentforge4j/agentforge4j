...
//  - 12 of 13 real routes (every one except /builder) render BYTE-IDENTICAL markup whether served
//    from the static shell or freshly mounted by this call — there is no possible visible
//    difference for those routes; the "replacement" is a no-op in effect even though it is a real
//    full-subtree replace.
...
//  - Across all 13 routes: zero console errors/warnings and zero page errors during load; the
//    real DOM already has real text content at the earliest measurable paint (no blank frame);
//    client-side navigation, browser back/forward, and keyboard focus (Tab reaches the skip link
//    first, matching pre-existing behaviour) all work unchanged; /builder mounts its real
//    interactive canvas (not the Suspense loading state) and its nodes are actually draggable.
