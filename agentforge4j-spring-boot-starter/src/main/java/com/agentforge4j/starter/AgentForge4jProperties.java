 ...
 *     loading)
 * @param integrations integration loading settings ({@code agentforge4j.integrations.*}); when
 *     absent, integration loading is skipped and tool support is unchanged
