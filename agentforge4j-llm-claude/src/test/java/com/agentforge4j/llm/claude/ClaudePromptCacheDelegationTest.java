 ...
 * Claude wrapper does not log the prompt-cache decision itself, and that it keeps no member the
 ...
 */
class ClaudePromptCacheDelegationTest {
  ...
  void theWrapperAcquiresNoLoggerAnywhere() throws IOException {
    String classFile = classFileOf(ClaudePromptCacheSupport.class);
    ...
    assertThat(classFile)
        .as("%s references a logger; the prompt-cache decision is logged once, by "
            ...
            ClaudePromptCacheSupport.class.getSimpleName())
  ...
  void theWrapperDeclaresNoLoggerField() {
    for (Field field : ClaudePromptCacheSupport.class.getDeclaredFields()) {
      assertThat(field.getType())
          .as("%s declares a logger field", ClaudePromptCacheSupport.class.getSimpleName())
  ...
  void theWrapperKeepsOnlyItsProviderSpecificState() {
    ...
    assertThat(ClaudePromptCacheSupport.class.getDeclaredFields())
  ...
  void theWrapperKeepsOnlyItsProductionEntryPoint() {
    ...
    assertThat(Arrays.stream(ClaudePromptCacheSupport.class.getDeclaredMethods())
